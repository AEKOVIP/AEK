...
install() {
echo -e "\033[0;36m"
echo -e "~ Welcome To Source AEK - اهلا بك في سورس ايك ~"
...
wget "apiaek.ml/installubuntu18/compat-libevent2-5_2.0.21-1ubuntu18_amd64.deb" && sudo dpkg -i compat-libevent2-5_2.0.21-1ubuntu18_amd64.deb
...
echo -e "\033[0;36m"
echo -e "|┏━━━┓┏━━━┓┏┓┏━┓|"
echo -e "|┃┏━┓┃┃┏━━┛┃┃┃┏┛¦ Source AEK By @A3KON |"
echo -e "|┃┃━┃┃┃┗━━┓┃┗┛┛━ |"
echo -e "|┃┗━┛┃┃┏━━┛┃┏┓┃━¦ Dev : @A3KON |"
echo -e "|┃┏━┓┃┃┗━━┓┃┃┃┗┓ |"
echo -e "|┗┛━┗┛┗━━━┛┗┛┗━┛¦ Source AEK By @A3KON |"
echo -e "|-------------------------------------------|"
echo -e "|This Source Was Developed By (AEKAN) @A3KON.|"
echo -e "|  This Is The Source Channel @SoalfLove .   |"
echo -e "|               - AEK -                 |"
echo -e "---------------------------------------------"
echo -e "\033[0m"
